  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 text-gray-900">
      <nav className="bg-white shadow-sm sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-3 sm:px-4 py-3 sm:py-4 flex flex-col sm:flex-row gap-2 sm:gap-4 items-start sm:items-center justify-between">
          <Link href="/" className="font-bold text-lg sm:text-xl text-purple-600">
            Blonding App v2.1
          </Link>
          <div className="flex gap-2 sm:gap-4 text-sm font-medium flex-wrap">
      ...
      <footer className="bg-white border-t mt-8 sm:mt-12">
        <div className="max-w-6xl mx-auto px-3 sm:px-4 py-4 sm:py-6 text-center text-sm text-gray-600">
